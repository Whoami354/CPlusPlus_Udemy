...
int main()
{
	...
	// Aufgabe 2
	cout << endl << "Starting exercise 2";
	auto start = std::chrono::high_resolution_clock::now();
	BinaryArray result_exercise2 = shuffle_till_equal(target, input);
	auto end = std::chrono::high_resolution_clock::now();
	int elapsed_milliseconds = std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count();
	cout << endl << "Time for exercise 2 in ms: " << elapsed_milliseconds;
	cout << endl << "Legit Solution: " << std::equal(result_exercise2.begin(), result_exercise2.end(), target.begin());
	cout << endl;
	

	// Aufgabe 3
	cout << endl << "Starting exercise 3";
	...
	cout << endl << "Time for exercise 3 in ms: " << elapsed_milliseconds;
	cout << endl << "Legit Solution: " << std::equal(result_exercise3.begin(), result_exercise3.end(), target.begin());
	cout << endl;
